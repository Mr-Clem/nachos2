...
ExceptionHandler (ExceptionType which)
{
	...
	case SyscallException:
        ...
        case SC_PutString:
        {
            ...
            int RH = 0;     //Reading Head
            while (StringSize == MAX_STRING_SIZE){
                RH = LC*MAX_STRING_SIZE;
                StringSize = copyStringFromMachine(from+RH, to, MAX_STRING_SIZE);
        ...
        case SC_ThreadCreate:
        {
          ...
          if(id == -1){
            synchconsole->SynchPutString("Sorry no more space");
          }
          break;
        }
        case SC_ThreadExit:
